...
var (
	_ cache.Informers = &informerCache{}
	_ client.Reader   = &informerCache{}
	_ cache.Cache     = &informerCache{}
)
...
func applyGetOptions(opts ...cache.InformerGetOption) *internal.GetOptions {
	cfg := &cache.InformerGetOptions{}
...
func (ic *informerCache) GetInformerForKind(ctx context.Context, gvk schema.GroupVersionKind, opts ...cache.InformerGetOption) (cache.Informer, error) {
...
func (ic *informerCache) GetInformer(ctx context.Context, obj client.Object, opts ...cache.InformerGetOption) (cache.Informer, error) {
...
func indexByField(informer cache.Informer, field string, extractValue client.IndexerFunc, clusterIndexes bool) error {
	...
	return informer.AddIndexers(toolscache.Indexers{internal.FieldIndexName(field): indexFunc})
}
