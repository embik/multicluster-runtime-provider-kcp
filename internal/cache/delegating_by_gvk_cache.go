...
func (dbt *delegatingByGVKCache) GetInformer(ctx context.Context, obj client.Object, opts ...cache.InformerGetOption) (cache.Informer, error) {
	cache, err := dbt.cacheForObject(obj)
	if err != nil {
		return nil, err
	}
...
func (dbt *delegatingByGVKCache) GetInformerForKind(ctx context.Context, gvk schema.GroupVersionKind, opts ...cache.InformerGetOption) (cache.Informer, error) {
...
func (dbt *delegatingByGVKCache) cacheForObject(o runtime.Object) (cache.Cache, error) {
...
func (dbt *delegatingByGVKCache) cacheForGVK(gvk schema.GroupVersionKind) cache.Cache {
